...
public class RutasFacadeREST extends AbstractFacade<Rutas> {
    ...
    public void create(Rutas entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Rutas entity) {
        super.edit(entity);
    }
    ...
    public Rutas find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Rutas> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
